        ...
        if (buttonDescription === 'See More' || buttonDescription === 'See Less') {
            return (
                <Button
                    ...
                    className="mt-auto w-[85px] h-[30px] lg:w-[170px] lg:h-[60px] bg-[#262626] text-white duration-300 transition font-montserrat text-sm lg:text-[25px] font-semibold rounded-[5px] px-[20px]"
                >
        ...
        <div className="flex flex-col items-center justify-center">
            {events.length > 6 && (
                <div className="w-full flex flex-row items-between justify-between lg:items-between lg:flex-row lg:justify-between lg:gap-20 2xl:gap-[300px] mb-5 md:mb-8 lg:mb-10">
                    <h2 className="text-black font-pt_sans lg:leading-[70px] text-[30px] lg:text-3xl xl:text-4xl 2xl:text-5xl font-bold">
                        {subTitle}
                    </h2>
                    {renderButton()}
                </div>
            ...
            <div className="flex flex-wrap items-center justify-center w-full gap-x-10 lg:gap-x-8 xl:gap-x-5 2xl:gap-x-24 gap-y-20 lg:gap-y-16">
